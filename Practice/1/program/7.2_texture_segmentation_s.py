...
def textures_segmentation_standard_deviation(image):
    '''
    ...
    print(m,n)
    smooth_Rim = np.uint8(local_standard_deviation)
...
segmentedFrames1 = textures_segmentation_standard_deviation(I1)
...
plt.suptitle('texture characteristic: standard deviation')
plt.show()
