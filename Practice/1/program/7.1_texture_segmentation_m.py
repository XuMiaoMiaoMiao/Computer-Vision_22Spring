...
def textures_segmentation_mean(image):
    '''
...
segmentedFrames1 = textures_segmentation_mean(I1)
...
plt.suptitle('the features of smoothness:mean value')
plt.show()
